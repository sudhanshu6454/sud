...
Every story gets two covers, generated by `autopub/autopub/images.py`: a 1200x630 landscape (the
WordPress featured image and the OG/Twitter/LinkedIn card) and a 1080x1080 square (Instagram,
Threads, Pinterest). When the source article has a photo it *is* the cover - sharp, cover-fitted,
