...
ICONS = {
    ...
    "FILMYBUFF": (None,                  "autopub/config/brand/filmybuff-mark.png",          "#14101C", 0.78, None),
}
...
TEXT_MARKS: dict[str, tuple[str, str, str, str]] = {
    "FILMYBUFF": ("filmybuff", "fb", "#FFFFFF", "#FFB627"),   # white type on the marquee ground, amber point
}
