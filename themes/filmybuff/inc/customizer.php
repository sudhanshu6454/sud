...
function fb_customize( $wp_customize ) {
	...
	$fields = array(
		'fb_show_topbar'       => array( 'checkbox', __( 'Show the "Now showing" top bar', 'filmybuff' ), true ),
		'fb_topbar_text'       => array( 'textarea', __( 'Top bar items (one per line; empty = the newest stories)', 'filmybuff' ), '' ),
		'fb_instagram'         => array( 'text', __( 'Instagram handle (without @)', 'filmybuff' ), 'filmybuff' ),
		'fb_rail_cats'         => array( 'text', __( 'Homepage rail section slugs (comma separated)', 'filmybuff' ), 'bollywood,hollywood,south-cinema' ),
		'fb_ott_cat'           => array( 'text', __( 'OTT strip section slug', 'filmybuff' ), 'ott-releases' ),
		'fb_boxoffice_cat'     => array( 'text', __( 'Box office ledger section slug', 'filmybuff' ), 'box-office' ),
		'fb_trailers_cat'      => array( 'text', __( 'Trailers row section slug', 'filmybuff' ), 'trailers' ),
		'fb_ledger_title'      => array( 'text', __( 'Box office aside: headline', 'filmybuff' ), __( 'Opening day tells you the marketing. Day eight tells you the film.', 'filmybuff' ) ),
		'fb_ledger_body'       => array( 'textarea', __( 'Box office aside: text', 'filmybuff' ), __( 'We report collections as the trade reports them, in crore, gross and net where both are known, and we say when they are estimates.', 'filmybuff' ) ),
		'fb_newsletter_action' => array( 'url', __( 'Newsletter form action URL (Mailchimp / Beehiiv / Substack embed endpoint)', 'filmybuff' ), '' ),
		'fb_newsletter_title'  => array( 'text', __( 'Newsletter headline', 'filmybuff' ), __( 'Friday releases, Sunday numbers, in your inbox.', 'filmybuff' ) ),
